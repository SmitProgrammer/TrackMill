...
"}\n"
"\n"
"QPushButton#btnSaveSettings, QPushButton#btnChangePassword, QPushButton#btnBackupData, QPushButton#btnRestoreData {\n"
"    padding: 12px 25px;\n"
"    border-radius: 5px;\n"
"    font-size: 13px;\n"
"    font-weight: bold;\n"
...
"}\n"
"\n"
"QPushButton#btnBackupData {\n"
"    background-color: #FF9800;\n"
"    color: white;\n"
"    border: none;\n"
"}\n"
"\n"
"QPushButton#btnBackupData:hover {\n"
"    background-color: #e68900;\n"
"}\n"
"\n"
"QPushButton#btnRestoreData {\n"
...
"}\n"
"\n"
"QPushButton#btnRestoreData:hover {\n"
...
"}")
        ...
        self.label_2.setStyleSheet(u"font-weight: normal; color: #555;")
        ...
        self.label_3.setStyleSheet(u"font-weight: normal; color: #555;")
        ...
        self.label_4.setStyleSheet(u"font-weight: normal; color: #555;")
        ...
        self.label_5.setStyleSheet(u"font-weight: normal; color: #555;")
        ...
        self.label_6.setStyleSheet(u"font-weight: normal; color: #555;")

        self.horizontalLayout.addWidget(self.label_6)

        self.lblCurrentUser = QLabel(self.groupAccount)
        self.lblCurrentUser.setObjectName(u"lblCurrentUser")
        self.lblCurrentUser.setStyleSheet(u"font-weight: bold; color: #2196F3;")
        ...
        self.groupBackup = QGroupBox(SettingsWidget)
        self.groupBackup.setObjectName(u"groupBackup")
        self.verticalLayout_3 = QVBoxLayout(self.groupBackup)
        self.verticalLayout_3.setSpacing(15)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.verticalLayout_3.setContentsMargins(15, 15, 15, 15)
        self.label_7 = QLabel(self.groupBackup)
        self.label_7.setObjectName(u"label_7")
        self.label_7.setStyleSheet(u"font-weight: normal; color: #666; font-size: 12px;")

        self.verticalLayout_3.addWidget(self.label_7)

        self.horizontalLayout_2 = QHBoxLayout()
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.btnBackupData = QPushButton(self.groupBackup)
        self.btnBackupData.setObjectName(u"btnBackupData")
        self.btnBackupData.setMinimumSize(QSize(0, 40))
        self.btnBackupData.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.horizontalLayout_2.addWidget(self.btnBackupData)

        self.btnRestoreData = QPushButton(self.groupBackup)
        self.btnRestoreData.setObjectName(u"btnRestoreData")
        self.btnRestoreData.setMinimumSize(QSize(0, 40))
        self.btnRestoreData.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.horizontalLayout_2.addWidget(self.btnRestoreData)


        self.verticalLayout_3.addLayout(self.horizontalLayout_2)


        self.verticalLayout.addWidget(self.groupBackup)
    ...
    def retranslateUi(self, SettingsWidget):
        ...
        self.groupBackup.setTitle(QCoreApplication.translate("SettingsWidget", u"Data Backup & Restore", None))
        self.label_7.setText(QCoreApplication.translate("SettingsWidget", u"Export and import your database for backup purposes", None))
        self.btnBackupData.setText(QCoreApplication.translate("SettingsWidget", u" Backup Database", None))
        self.btnRestoreData.setText(QCoreApplication.translate("SettingsWidget", u" Restore Database", None))
